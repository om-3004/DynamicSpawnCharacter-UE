...
ATP_TopDownCharacter::ATP_TopDownCharacter()
{
	...
	PawnAttributeAsset = LoadObject<UPawnAttributeAsset>(this, TEXT("/Script/PawnPossession.PawnAttributeAsset'/Game/Blueprint/TopDown_Properties.TopDown_Properties'"));
}
